...
### Update
After comparing my `.gitattributes` with my teammates', I noticed I had some additional Git LFS attributes. After making sure I've removed them from my `.gitconfig` file, the issue has been resolved.